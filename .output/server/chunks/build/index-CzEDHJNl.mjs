...
import { _ as _sfc_main$3 } from './wallet-Dl1e5hJs.mjs';
import { a as useRollupsStore, u as useWalletStore } from './rollups-mW1IBXdI.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "phase-box mt-8 lg:mt-12 cursor-pointer" }, _attrs))} data-v-d76aac27><div class="py-4 px-8 phase-inner1 relative" data-v-d76aac27><div class="phase-box-left absolute left-0 top-0 bottom-0 h-full w-12" data-v-d76aac27></div><div class="phase-box-right absolute right-0 top-0 bottom-0 h-full w-12" data-v-d76aac27></div><div class="flex items-center" data-v-d76aac27><div class="w-24 lg:w-32 flex flex-col items-center mr-8 lg:mr-16" data-v-d76aac27><div class="relative w-20 lg:w-28" data-v-d76aac27><img${ssrRenderAttr("src", _imports_0)} class="absolute left-0 right-0 top-0 bottom-0" data-v-d76aac27><img${ssrRenderAttr("src", unref(rollup).img)} class="w-16 lg:w-24 rounded-full m-2" data-v-d76aac27></div>`);
      if (!_ctx.main) {
        _push(`<div class="h-16 font-bold text-sm flex items-center text-center" data-v-d76aac27>${ssrInterpolate(unref(rollup).name)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (!_ctx.main) {
        _push(`<div class="flex-1 grid grid-cols-2 lg:grid-cols-4" data-v-d76aac27><div class="flex flex-col items-start justify-center" data-v-d76aac27><div class="lg:text-2xl font-bold" data-v-d76aac27>${ssrInterpolate(unref(rollup).layer1 || "-")}</div><div class="text-text-500 mt-2" data-v-d76aac27>${ssrInterpolate(_ctx.$t("rollups.base"))}</div></div><div class="flex flex-col items-start justify-center" data-v-d76aac27><div class="lg:text-2xl font-bold" data-v-d76aac27>${ssrInterpolate(unref(rollup).zkevmType || "-")}</div><div class="text-text-500 mt-2" data-v-d76aac27>${ssrInterpolate(_ctx.$t("rollups.zkType"))}</div></div><div class="flex flex-col items-start justify-center mt-4 lg:mt-0" data-v-d76aac27><div class="lg:text-2xl font-bold" data-v-d76aac27>${ssrInterpolate(unref(rollup).da || "-")}</div><div class="text-text-500 mt-2" data-v-d76aac27>${ssrInterpolate(_ctx.$t("rollups.da"))}</div></div><div class="flex flex-col items-start justify-center mt-4 lg:mt-0" data-v-d76aac27><div class="lg:text-2xl font-bold" data-v-d76aac27>${ssrInterpolate(unref(rollup).gasToken || "-")}</div><div class="text-text-500 mt-2" data-v-d76aac27>${ssrInterpolate(_ctx.$t("rollups.token"))}</div></div></div>`);
      } else {
        _push(`<div class="flex-1" data-v-d76aac27><div class="flex items-center" data-v-d76aac27><span class="text-lg mr-4 font-bold" data-v-d76aac27>${ssrInterpolate(unref(rollup).name)}</span><a${ssrRenderAttr("href", unref(rollup).bridge)} target="_blank" class="text-xs text-[#aaa] hover:underline hover:text-primary-900 mr-4" data-v-d76aac27>${ssrInterpolate(_ctx.$t("rollups.bridge"))}</a>`);
        if (!unref(walletStore).account) {
          _push(ssrRenderComponent(_component_Wallet, null, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<a class="text-xs text-[#aaa] hover:underline hover:text-primary-900" data-v-d76aac27${_scopeId}>${ssrInterpolate(_ctx.$t("rollups.add"))}</a>`);
              } else {
                return [
                  createVNode("a", {
                    onClick: addNetwork,
          ...
          _push(`<a class="text-xs text-[#aaa] hover:underline hover:text-primary-900" data-v-d76aac27>${ssrInterpolate(_ctx.$t("rollups.add"))}</a>`);
        }
        _push(`</div><div class="text-[#aaa] text-sm mt-2" data-v-d76aac27>${ssrInterpolate(unref(rollup).des)}</div><div class="flex items-center mt-4 card-icons" data-v-d76aac27><a class="cursor-pointer mr-2 hvr-float rounded-lg"${ssrRenderAttr("href", unref(rollup).home)} target="_blank" data-v-d76aac27><img${ssrRenderAttr("src", _imports_1)} data-v-d76aac27></a><a class="cursor-pointer mr-2 hvr-float rounded-lg"${ssrRenderAttr("href", unref(rollup).twitter)} target="_blank" data-v-d76aac27><img${ssrRenderAttr("src", _imports_2)} data-v-d76aac27></a><a class="cursor-pointer hvr-float rounded-lg"${ssrRenderAttr("href", unref(rollup).dc)} target="_blank" data-v-d76aac27><img${ssrRenderAttr("src", _imports_3)} data-v-d76aac27></a></div><div class="mt-4 grid grid-cols-2 lg:grid-cols-4" data-v-d76aac27><div class="flex flex-col items-start justify-center" data-v-d76aac27><div class="lg:text-2xl font-bold" data-v-d76aac27>${ssrInterpolate(unref(rollup).layer1 || "-")}</div><div class="text-text-500 mt-2" data-v-d76aac27>${ssrInterpolate(_ctx.$t("rollups.base"))}</div></div><div class="flex flex-col items-start justify-center" data-v-d76aac27><div class="lg:text-2xl font-bold" data-v-d76aac27>${ssrInterpolate(unref(rollup).tvl || "-")}</div><div class="text-text-500 mt-2" data-v-d76aac27>${ssrInterpolate(_ctx.$t("rollups.tvl"))}</div></div><div class="flex flex-col items-start justify-center mt-4 lg:mt-0" data-v-d76aac27>`);
        ...
        _push(`<div class="text-text-500 mt-2" data-v-d76aac27>${ssrInterpolate(_ctx.$t("rollups.transactions"))}</div></div><div class="flex flex-col items-start justify-center mt-4 lg:mt-0" data-v-d76aac27>`);
        _push(ssrRenderComponent(_component_CountUp, {
        ...
        _push(`<div class="text-text-500 mt-2" data-v-d76aac27>${ssrInterpolate(_ctx.$t("rollups.users"))}</div></div></div></div>`);
      }
      _push(`</div></div></div>`);
    };
  }
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d76aac27"]]);
...
//# sourceMappingURL=index-CzEDHJNl.mjs.map
