export default function draw() { 
    ...
    let parent = document.getElementById("rollup-draw-box") 
    let postctx = parent.appendChild(document.createElement('canvas')).getContext('2d') 
    let canvas = c.canvas 
    let vertices = [] 
    ...
    let loop = (timeStamp) => { 
        ...
        // Clear both contexts for transparency
        c.clearRect(0, 0, canvas.width, canvas.height)
        postctx.clearRect(0, 0, postctx.canvas.width, postctx.canvas.height)
        c.save() 
